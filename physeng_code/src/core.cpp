...
//-----------------------------------------------------------------------------
vec3_t cyclone::Vec3Construct(real_t x, real_t y, real_t z)
{
    vec3_t v = { x, y, z };
    return v;
}
...
//
//-----------------------------------------------------------------------------
mat3_t cyclone::Mat3Construct(real_t c0, real_t c1, real_t c2, real_t c3,
    real_t c4, real_t c5, real_t c6, real_t c7, real_t c8)
{
    mat3_t m = { c0, c1, c2, c3, c4, c4, c6, c7, c8 };
    return m;
}
